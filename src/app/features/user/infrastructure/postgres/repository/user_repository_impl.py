...
from src.app.features.user.infrastructure.postgres.repository.user_model_mapper import map_model_to_entity
...
class UserRepositoryImpl(UserRepository):
    ...
    async def find_all(self, limit: Optional[int] = None, offset: Optional[int] = None) -> List[T]:
        ...
        return [map_model_to_entity(m) for m in models]
